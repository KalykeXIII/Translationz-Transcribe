...
var contents = document.getElementById("transcript").value

var fileName =  'transcript.txt'; // You can use the .txt extension if you want

$('#save-button').click(function(){
    downloadInnerHtml(fileName, 'contents','text/html');
});
...
function toggleUploadSubmit(disableUpload = false) {
    $('#upload-button').prop('disabled',disableUpload);
    $('#submit-button').attr("disabled",!disableUpload);
}
